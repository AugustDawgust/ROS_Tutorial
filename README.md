...
Click `/<your_username>_ros_tutorial_<version>`. If prompted to open a folder, select colcon_ws -> src. You should have something like this (without the answer folders).
